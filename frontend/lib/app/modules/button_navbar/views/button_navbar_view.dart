...
import '../../discover_screen/views/discover_screen_view.dart';
...
class ButtonNavbarView extends GetView<ButtonNavbarController> {
  ...
  static final List<CurvedNavigationBarItem> _androidNavItems = [
    ...
    const CurvedNavigationBarItem(child:Icon(Icons.shopping_bag),
      label: 'Booking',),
    ...
    return Obx(
      () => AdaptiveScaffold(
        ...
        bottomNavigationBar: AdaptiveBottomNavigationBar(
          ...
          bottomNavigationBar: Platform.isAndroid ? _androidBottomBar(context) : null,
        ),
      ),
    );
  }
