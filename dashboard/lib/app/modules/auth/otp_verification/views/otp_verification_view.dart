                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(
                                  "${"otp_verification_subtitle".tr} ${controller.maskedEmail}",
                              ...
                              Row(
                                ...
                                children: List.generate(controller.codeLength, (
                                  index,
                                ) {
                                  return SizedBox(
                                    width: 44,
                              ...
                              Center(
                                child: controller.canResend
                                    ...
                                    : Text(
                                        '${"resend_code_in".tr} 00:${controller.secondsRemaining.value.toString().padLeft(2, '0')}',
                                        style: _font(
                                          "resend_code_in".tr,
                                          color: subtitleColor,
                                          fontSize: 13,
